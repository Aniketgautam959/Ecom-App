          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="text-right mt-1">
                <Link href="/forgot-password" className="text-xs text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">Forgot password?</Link>
              </div>
            </div>
            ...
            <p className="text-center text-sm text-gray-500 dark:text-gray-400">
              ...
              <Link href="/register" className="font-semibold text-gray-900 dark:text-white underline">Sign Up</Link>
            </p>
          </form>
        </div>
      </main>
