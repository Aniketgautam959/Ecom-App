import { Pressable, SafeAreaView, ScrollView, Text, Linking } from "react-native";
  ...
  return (
    <SafeAreaView style={styles.flex}>
      ...
      <ScrollView contentContainerStyle={styles.form}>
        ...
        <Pressable onPress={() => open("mailto:support@ecommerce.com")}>
          <Text style={styles.link}>support@ecommerce.com</Text>
        </Pressable>
        <Pressable onPress={() => open("tel:+919876543210")}>
