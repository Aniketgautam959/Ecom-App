    ...
    <SafeAreaView style={styles.flex}>
      ...
      {loading ? (
        ...
        <FlatList
          ...
          ListEmptyComponent={<Text style={{ textAlign: "center", margin: 24, color: "#6B7280" }}>Your wishlist is empty.</Text>}
          renderItem={({ item }) => {
                ...
                <View style={styles.card}>
                  ...
                  <View style={styles.cardBody}>
                    ...
                    <View style={[styles.row, styles.gapSm, { marginTop: 8 }]}>
                      <Pressable style={[styles.primaryButton, { flex: 1 }]} onPress={() => add(item)}>
                        <Text style={styles.primaryButtonText}>Add to Cart</Text>
                      </Pressable>
                      <Pressable style={[styles.secondaryButton, { paddingHorizontal: 10 }]} onPress={() => remove(item)}>
